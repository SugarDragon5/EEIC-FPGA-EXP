...
\section{基本課題}
\input{source/basic.tex}
\section{自由課題 ～巡回セールスマン問題～}
\input{source/advance_theme.tex}
\section{自由課題 実験内容}
\input{source/advance.tex}
\section{自由課題 実験結果}
\input{source/advance_result.tex}
\section{自由課題に対する考察と追加実験}
\input{source/advance_discuss.tex}
\section{レポート課題}
\input{source/report.tex}
\section{参考文献}
\input{source/reference.tex}
\end{document}